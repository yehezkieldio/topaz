...
export const MdxDivider = (props: ComponentPropsWithoutRef<"hr">) => (
...
export const MdxTableHead = (props: ComponentPropsWithoutRef<"thead">) => (
  <thead className="border-border/70 border-b" {...props} />
);

export const MdxTableBody = (props: ComponentPropsWithoutRef<"tbody">) => (
  <tbody {...props} />
);

export const MdxTableHeadCell = ({
  children,
  ...props
